...
export default function Partners() {
	return (
		<div className="max-ctn px-0 flex justify-between max-md:justify-start items-center flex-wrap gap-8 py-10">
			<img src={aws} alt="aws" className="h-14 max-md:h-8 w-auto" />
			<img src={dell} alt="dell" className="h-10 max-md:h-5 w-auto" />
			<img src={google} alt="google" className="h-12 max-md:h-7 w-auto" />
			<img src={openai} alt="openai" className="h-12 max-md:h-7 w-auto" />
